			...
			<div class="col-md-6">
				...
				<form action="RegisterServlet" method= "post">
					...
					<div class="form-group col-lg-6">
						...
						<input name="lastName" class="form-control" id="" value="">
					</div>
					
					<div class="form-group col-lg-6">
						<label>First Name</label>
						<input name="firstName" class="form-control" id="" value="">
					</div>
									
					<div class="form-group col-lg-6">
						<label>Email Address</label>
						<input name="email" class="form-control" id="" value="">
					</div>
					
					<div class="form-group col-lg-6">
						<label>Phone</label>
						<input name="phone" class="form-control" id="" value="">
					</div>			
